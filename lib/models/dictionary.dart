...
List<Definition> definitionFromjson(String str) =>
    List<Definition>.from(json.decode(str).map((x) => x.toJson()));
...
class Definition {
  String definition;
  List<String> synonyms; // Specify the type as List<String>
  List<String> antonyms; // Specify the type as List<String>
  String? example;
